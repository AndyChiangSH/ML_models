...
if __name__ == '__main__':
    ...
    model.add(Dense(units=1024, input_dim=28*28, kernel_initializer="normal", activation="relu"))
    ...
    # train model
    history = model.fit(x=train_feature_vector, y=train_label_onehot, validation_split=0.2, epochs=20, batch_size=200, verbose=1)
